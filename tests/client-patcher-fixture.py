...
with tempfile.TemporaryDirectory() as temp:
    ...
    if b"https://www.boomlings.com/database" in patched:
        raise SystemExit("Fixture test failed: GD 2.2 URL was not replaced.")

    if b"http://www.boomlings.com/database" in patched:
        raise SystemExit("Fixture test failed: legacy database URL was not replaced.")
