...
$assert(str_contains($rating,"/admin/assets/difficulty/'.rawurlencode($profile).'.svg"),'local GD difficulty face asset source');
$assert(!str_contains($rating,'geometrydash.wiki.gg/wiki/Special:Redirect/file'),'no external difficulty-face hotlink');
