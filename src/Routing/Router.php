...
final class Router
{
    ...
    public function normalizePath(string $path): string
    {
        ...
        static $compatAliases = [
            ...
            // Legacy unversioned endpoint aliases.
            // Cvolton's reference server exposes both versioned and
            // unversioned names; route all common legacy names to the
            // canonical MuchoCore implementation instead of returning -1.
            ...
            '/updategjaccsettings' => '/updateGJAccSettings20',
